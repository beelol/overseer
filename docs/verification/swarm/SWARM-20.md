...
Remaining: live Pause checkpoints, native descendants and VS Code display are not qualified. A checker orphaned by daemon death can still leave a stopping run waiting until checker reconciliation is triggered. SWARM-20 remains partial.
