...
Remaining: a real 60-second wall-clock transport outage has not yet been replayed. Confirmed dead-process reconciliation is covered only for a stopped generic worker, not qualified live harnesses. Per-job deadlines and retry after uncertain side effects need versioned fixtures and live qualification. This criterion stays unchecked.
