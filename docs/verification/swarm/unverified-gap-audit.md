...
Initially inspected at code revision `ffa08ba`; updated after fixture context and scheduling at `09d1a89`, writer isolation at `9a55173`, destination revocation at `51f072f`, and cross-target grants at `9148e84`. This is a gap audit, not verification evidence. The ledger currently has 13 `unverified` and 51 `partial` criteria, each with a specific remaining gap. None is checked in the RFC, and S0–S5 remain unverified.
