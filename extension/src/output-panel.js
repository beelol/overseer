...
<div><button id="review" class="secondary">Open Review</button><button id="raw" class="secondary">Raw output</button><button id="interrupt">Interrupt</button><span class="why" id="interrupt-why"></span></div>
